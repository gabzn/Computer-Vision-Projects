...
Original file is located at
    https://colab.research.google.com/drive/1aZwuybO94PDC-3xp508LwNioIqqkPIsQ
...
class StudentModel(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(20 * 3 * 3, 167)
        self.fc2 = nn.Linear(167, 76)
    ...
    def forward(self, x):
        ...
        x = x.view(-1, 3 * 3 * 20)  # Adjusted the flattening size here
        x = F.relu(self.fc1(x))
        x = F.relu(self.fc2(x))
        x = self.fc3(x)
        return x
